...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::livewire('prompts/{round}', 'pages::prompts.show')->name('prompts.show');
    Route::livewire('extracurriculars/{library}', 'pages::extracurriculars.show')->name('extracurriculars.show');
